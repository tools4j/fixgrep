...
class HighlightCriteriaTagValueContains(val tag: Int, val match: String): HighlightCriteria {
    override fun matches(fix: Fields): HighlightCriteriaMatch{
        ...
        if(field.value.valueRaw.contains(match)){
            return HighlightCriteriaMatch(field)
        } else {
            return HighlightCriteriaMatch.NO_MATCH
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is HighlightCriteriaTagValueContains) return false
