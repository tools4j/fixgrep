...
enum class Ansi16BackgroundColor(override val consoleTextBefore: String): TextEffect {
    ...
    companion object {
        ...
        fun listAsHtml(): String {
            ...
            Ansi16BackgroundColor.values().forEach {
                sb.append("<span class='").append(it.htmlClass).append(" ").append(it.foregroundColorForDemo.htmlClass).append("'>").append(it.htmlClass).append("</span>")
            }
            sb.append("</span>")
            return sb.toString()
        }
        ...
        fun listForConsole(): String {
            ...
            Ansi16BackgroundColor.values().forEach {
                ...
                sb.append(it.consoleTextBefore).append(it.foregroundColorForDemo.consoleTextBefore).append(it.htmlClass).append(it.consoleTextAfter)
            }
            return sb.toString()
        }
    }
