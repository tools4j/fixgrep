...
class UniqueClientOrderIdSpec(val idTag: Int, val senderTagId: Int?, val targetTagId: Int?, val otherUniqueTags: List<Int>) {
    constructor(): this(11, 49, 56, emptyList()) //default is clOrdId, and SenderCompId & TargetCompId
