 ...
 * Time: 6:39 AM
 */
class VerticalNonAlignedHtmlFieldFormatter(val fieldWriter: FieldWriter, val annotationPositions: AnnotationPositions, val boldTagAndValue: Boolean): FieldFormatter() {
    override fun finish() {
