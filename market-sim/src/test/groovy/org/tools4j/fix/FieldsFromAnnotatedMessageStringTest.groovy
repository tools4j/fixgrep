...
class FieldsFromAnnotatedMessageStringTest extends Specification {
    ...
    def "test parse expression"() {
        ...
        assert expression.get(1) == new FieldImpl(new AnnotatedTag(262, "MDReqID"), new NonEnumValue("AASDJKG790"))
        assert expression.get(2) == new FieldImpl(new AnnotatedTag(263, "SubscriptionRequestType"), new AnnotatedValue("0", "SNAPSHOT"))
        assert expression.get(3) == new FieldImpl(new AnnotatedTag(264, "MarketDepth"), new NonEnumValue("20"))
        assert expression.get(4) == new FieldImpl(new AnnotatedTag(267, "NoMDEntryTypes"), new NonEnumValue("2"))
        ...
        assert expression.get(7) == new FieldImpl(new AnnotatedTag(146, "NoRelatedSym"), new NonEnumValue("3"))
        assert expression.get(8) == new FieldImpl(new AnnotatedTag(55, "Symbol"), new NonEnumValue("GBP/USD"))
        assert expression.get(9) == new FieldImpl(new AnnotatedTag(55, "Symbol"), new NonEnumValue("AUD/USD"))
        assert expression.get(10) == new FieldImpl(new AnnotatedTag(55, "Symbol"), new NonEnumValue("USD/JPY"))
    }
}
